package com.leimo.common.basicdata;
...
public class ArrayUtil {
    ...
    /**
     * is not null or its length is more than the 0
     *
     * @param <V>
     * @param sourceArray
     * @return
     */
    public static <V> boolean isNoEmpty(V[] sourceArray) {
        return !isEmpty(sourceArray);
    }

    /**
     * 获取目标元素的最后一个元素，然后从头到尾匹配目标元素
    ...
    /**
     * 获取目标元素的下一个元素，在匹配目标元素前后的第一个元素之后
